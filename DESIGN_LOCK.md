# HV P2P NMS design lock — v26.09.03.01
...
The compiled version string is `v26.09.03.01`; the design-reference images contain earlier concept version labels and are references for layout/appearance only.
