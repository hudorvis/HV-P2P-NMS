# HV P2P NMS design lock — v26.09.01.04
...
The compiled version string is `v26.09.01.04`; the design-reference images contain earlier concept version labels and are references for layout/appearance only.
