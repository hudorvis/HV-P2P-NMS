# GitHub Actions build debug — v26.09.02.01
...
This revision makes only CI/build-pipeline changes:
...
The application UI, backend behaviour, discovery logic, favourites, scan persistence, and design lock are unchanged apart from the revision string.
